...
/datum/subsystem/ticker/New()
	...
	login_music = pickweight(list('sound/ambience/title2.ogg' = 30, 'sound/ambience/title1.ogg' =30, 'sound/ambience/title3.ogg' =1, 'sound/ambience/title4.ogg' =1, 'sound/misc/i_did_not_grief_them.ogg' =1, 'sound/ambience/clown.ogg' = 1)) // choose title music!
